...
/***/ "./src/app/list/movie-list.service.ts":
/*!********************************************!*\
  !*** ./src/app/list/movie-list.service.ts ***!
  \********************************************/
...
/***/ "./src/app/list/movie-list/movie-list.component.css":
/*!**********************************************************!*\
  !*** ./src/app/list/movie-list/movie-list.component.css ***!
  \**********************************************************/
/*! no static exports found */
...
module.exports = "*{list-style-type: none;}\r\n\r\n#wrapper {\r\n  width: 80vw;\r\n  overflow: hidden;\r\n}\r\n\r\n#img {\r\n  width: 200px;\r\n  float:left;\r\n}\r\n\r\n#info {\r\n  float: left;\r\n}\r\n\r\n#title {\r\n  font-size: 1.6em;\r\n}\r\n\r\n#time {\r\n  font-size: 1.2em;\r\n}\r\n"

/***/ }),

/***/ "./src/app/list/movie-list/movie-list.component.html":
/*!***********************************************************!*\
  !*** ./src/app/list/movie-list/movie-list.component.html ***!
  \***********************************************************/
/*! no static exports found */
...
/***/ "./src/app/list/movie-list/movie-list.component.ts":
/*!*********************************************************!*\
  !*** ./src/app/list/movie-list/movie-list.component.ts ***!
  \*********************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _movie_list_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../movie-list.service */ "./src/app/list/movie-list.service.ts");
...
var MovieComponent = /** @class */ (function () {
    function MovieComponent(http, ngxXml2jsonService, movieService, fb, router) {
        this.http = http;
    ...
    MovieComponent.prototype.getTimes = function () {
        var _this = this;
        ...
        this.http.get(this.xml, {
            ...
            _this.times = obj['Dates']['dateTime'];
        }, function (error) { return console.log('oops', error); });
    };
    MovieComponent.prototype.getAreas = function () {
        var _this = this;
        ...
        this.http.get(this.xml, {
            ...
            var xml = parser.parseFromString(data, 'text/xml');
            var obj = _this.ngxXml2jsonService.xmlToJson(xml);
            _this.places = obj['TheatreAreas']['TheatreArea'];
            console.log(_this.places);
        }, function (error) { return console.log('oops', error); });
    };
    MovieComponent.prototype.getMovies = function (city, date) {
        var _this = this;
        this.movies = [];
        ...
        this.http.get(this.xml, {
            ...
            var xml = parser.parseFromString(data, 'text/xml');
            var obj = _this.ngxXml2jsonService.xmlToJson(xml);
            _this.movies = obj['Schedule']['Shows']['Show'];
            console.log(_this.movies);
        }, function (error) { return console.log('oops', error); });
    };
    MovieComponent.prototype.formatDate = function (inputDate) {
    ...
    MovieComponent.prototype.onSubmit = function () {
    ...
    MovieComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./movie-list.component.html */ "./src/app/list/movie-list/movie-list.component.html"),
            styles: [__webpack_require__(/*! ./movie-list.component.css */ "./src/app/list/movie-list/movie-list.component.css")],
        }),
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"],
            ngx_xml2json__WEBPACK_IMPORTED_MODULE_3__["NgxXml2jsonService"],
            _movie_list_service__WEBPACK_IMPORTED_MODULE_1__["MovieService"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"]])
    ], MovieComponent);
...
/***/ "./src/app/list/reservations/reservation-details/reservation-details.component.css":
/*!*****************************************************************************************!*\
  !*** ./src/app/list/reservations/reservation-details/reservation-details.component.css ***!
  \*****************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/list/reservations/reservation-details/reservation-details.component.html":
/*!******************************************************************************************!*\
  !*** ./src/app/list/reservations/reservation-details/reservation-details.component.html ***!
  \******************************************************************************************/
/*! no static exports found */
...
var ReservationDetailsComponent = /** @class */ (function () {
    ...
    ReservationDetailsComponent.prototype.deleteReservation = function (reservationId) {
        ...
        this.reservationService.deleteReservation(reservationId).then(function (deletedReservationId) {
            _this.deleteHandler(deletedReservationId);
        });
    };
    __decorate([
    ...
    ], ReservationDetailsComponent.prototype, "deleteHandler", void 0);
    ReservationDetailsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-reservation-details',
            template: __webpack_require__(/*! ./reservation-details.component.html */ "./src/app/list/reservations/reservation-details/reservation-details.component.html"),
            styles: [__webpack_require__(/*! ./reservation-details.component.css */ "./src/app/list/reservations/reservation-details/reservation-details.component.css")]
        }),
        __metadata("design:paramtypes", [_reservation_service__WEBPACK_IMPORTED_MODULE_2__["ReservationService"]])
...
/***/ "./src/app/list/reservations/reservation-list/reservation-list.component.css":
/*!***********************************************************************************!*\
  !*** ./src/app/list/reservations/reservation-list/reservation-list.component.css ***!
  \***********************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/list/reservations/reservation-list/reservation-list.component.html":
/*!************************************************************************************!*\
  !*** ./src/app/list/reservations/reservation-list/reservation-list.component.html ***!
  \************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/list/reservations/reservation-list/reservation-list.component.ts":
/*!**********************************************************************************!*\
  !*** ./src/app/list/reservations/reservation-list/reservation-list.component.ts ***!
  \**********************************************************************************/
...
var ReservationListComponent = /** @class */ (function () {
    function ReservationListComponent(reservationService) {
        ...
        this.deleteReservation = function (reservationId) {
            var idx = _this.getIndexOfReservation(reservationId);
            if (idx !== -1) {
                _this.reservations.splice(idx, 1);
                _this.selectReservation(null);
            }
...
/***/ "./src/app/list/reservations/reservation.service.ts":
/*!**********************************************************!*\
  !*** ./src/app/list/reservations/reservation.service.ts ***!
  \**********************************************************/
...
var ReservationService = /** @class */ (function () {
    function ReservationService(http) {
        this.http = http;
        this.reservationsUrl = '/api/reservations';
    }
    ...
    ReservationService.prototype.deleteReservation = function (delReservationId) {
...
/***/ "./src/app/list/reservations/reservation.ts":
/*!**************************************************!*\
  !*** ./src/app/list/reservations/reservation.ts ***!
  \**************************************************/
...
/***/ "./src/app/list/reservations/seats/seats.component.css":
/*!*************************************************************!*\
  !*** ./src/app/list/reservations/seats/seats.component.css ***!
  \*************************************************************/
/*! no static exports found */
...
module.exports = ".font14 {\r\n  font-size: 14px;\r\n}\r\n.font16 {\r\n  font-size: 16px;\r\n}\r\n.marginTop5 {\r\n  margin-top: 5px;\r\n}\r\n.marginTB10 {\r\n  margin: 10px 0px;\r\n}\r\n.wordWrap {\r\n  word-break: break-all;\r\n}\r\n.innerContainer {\r\n  color: rgb(24, 22, 22);\r\n  text-align: center;\r\n}\r\n.movie {\r\n  margin: -10px -5px 10px -5px;\r\n  height: 70px;\r\n  background: hsl(151, 75%, 43%);\r\n}\r\n.movieDetails {\r\n  font-size: 15px;\r\n  margin-top: -3px;\r\n}\r\n.movieTitle {\r\n  font-size: 20px;\r\n  padding-top: 10px;\r\n  margin-top: -3px;\r\n}\r\n.seat {\r\n  padding-right: 5px;\r\n}\r\n.legend {\r\n  font-size: 14px;\r\n}\r\n.legend > .padding-left {\r\n  padding-left: 15px;\r\n}\r\n.screen {\r\n  background: hsla(216, 72%, 50%, 0.65);\r\n  height: 3px;\r\n  border-radius: 15px;\r\n  margin: -5px 50px 10px;\r\n  box-shadow: 0px 3px 6px rgb(243, 234, 234);\r\n}\r\n.reservedSeat {\r\n  color: #e63933;\r\n}\r\n.selectedSeat {\r\n  color: #4fba4f;\r\n}\r\n.freeSeat {\r\n  color: rgb(88, 87, 83);\r\n}\r\n"

/***/ }),

/***/ "./src/app/list/reservations/seats/seats.component.html":
/*!**************************************************************!*\
  !*** ./src/app/list/reservations/seats/seats.component.html ***!
  \**************************************************************/
/*! no static exports found */
...
/***/ "./src/app/list/reservations/seats/seats.component.ts":
/*!************************************************************!*\
  !*** ./src/app/list/reservations/seats/seats.component.ts ***!
  \************************************************************/
